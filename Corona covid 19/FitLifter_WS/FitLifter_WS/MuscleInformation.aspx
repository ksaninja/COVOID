<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MuscleInformation.aspx.cs" Inherits="FitLifter_WS.MuscleInformation" %>
...
<div class="wrapper">
  ...
  <div class="main app form" id="main"><!-- Main Section -->
    <div class="hero-section">
     ...
     <div style="width:100%; height:50vw; background-color:red;">
             <iframe style=" width:100%; height:100%; background-color:white;" src="https://www.youtube.com/embed/8hkGXGZZJpg?controls=0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"></iframe>
  ...
  <%--  <div class="client-section" style="height:50px;">
   ...
   <%-- <div class="split-features">
    ...
    <div class="app-features text-center" id="SERVICES">
      <div class="container">
        <h1 class="wow fadeInDown" data-wow-delay="0.1s">Some Informations</h1>
        <p class="wow fadeInDown" data-wow-delay="0.2s"> Aliquam sagittis ligula et sem lacinia, ut facilisis enim sollicitudin. Proin nisi est,<br class="hidden-xs">
          convallis nec purus vitae, iaculis posuere sallis nec purus vitae, iaculis posuere sallis nec purus vitae, iaculis posuere sallis nec purus vitae, iaculis posuere sallis nec purus vitae, iaculis posuere sallis nec purus vitae, iaculis posuere sapien. </p>
        <div class="col-md-4 features-left">

          <div  class="col-md-12 wow fadeInDown" data-wow-delay="0.2s">
          <img class="img-responsive wow fadeIn" src="images/Mh001.jpg" alt="Image" />
          </div>
        ...
        <div class="col-md-4 features-left">
          ...
          <div  class="col-md-12 wow fadeInDown"  data-wow-delay="0.7s">
           <img class="img-responsive wow fadeIn" src="images/Mh002.jpg" alt="Image" />
          </div>
  ...
  <%--   <div class="split-features2" onclick="onclick1('1')" style="cursor:pointer;">
      ...
      <div class="col-md-6 nopadding">
        <div class="split-image"> <img class="img-responsive wow fadeIn" src="images/app-signup_003.png" alt="Image" /> </div>
      </div>
    </div>
--%>
            ...
            <div class="split-features">
      <div class="col-md-6 nopadding">
        <div class="split-image"> <img class="img-responsive wow fadeIn" src="images/app-signup_004.png" alt="Image" /> </div>
      </div>
      <div class="col-md-6 nopadding">
        <div class="split-content">
          <h1 class="wow fadeInUp">Designed for effective product landing page</h1>
   ...
   <%--  <div class="split-features2" onclick="onclick1('3')" style="cursor:pointer;">
      ...
      <div class="col-md-6 nopadding">
        <div class="split-image"> <img class="img-responsive wow fadeIn" src="images/app-signup_005.png" alt="Image" /> </div>
      </div>
    </div>--%>
...
tempore consequuntur officia ducimus unde doloribus quod unt repell  </p>
   ...
   <a id="back-Page" style="text-decoration:none; padding-left:10px; padding-top:6px; opacity:1;" class="back-to-Page page-scroll" href="MusclesList.aspx" ><i style="text-decoration:none; font-size:18px; color:white; opacity:1;  text-align:center; vertical-align:middle;">←</i></a> 
