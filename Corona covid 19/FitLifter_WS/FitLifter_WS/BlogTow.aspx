<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BlogTow.aspx.cs" Inherits="FitLifter_WS.BlogTow" %>
...
<div class="wrapper">
  <div class="container">
    <nav class="navbar navbar-default navbar-fixed-top">
      ...
      --%>    <a class="navbar-brand page-scroll"  href="ProfileHome.aspx"><img src="images/logo.png" width="112" height="27" alt="FitLifter" /></a> </div>
  ...
  <div class="main app form" id="main"><!-- Main Section -->
    ...
    <!-- Client Section -->
    <div class="client-section" style="height:100px; background-color:#f8f8f8;">
 ...
 <%--   <div class="app-features text-center" id="SERVICES">
    ...
    <div class="split-features">
      <div class="col-md-6 nopadding">
        <div class="split-image"> <img class="img-responsive wow fadeIn" src="images/covid001.png" alt="Image" /> </div>
      </div>
      <div class="col-md-6 nopadding">
     ...
     <div class="split-features2">
      ...
      <div class="col-md-6 nopadding">
        <div class="split-image"> <img class="img-responsive wow fadeIn" src="images/covid002.png" alt="Image" /> </div>
      </div>
    </div>

        <div class="split-features">
      <div class="col-md-6 nopadding">
        <div class="split-image"> <img class="img-responsive wow fadeIn" src="images/covid003.png" alt="Image" /> </div>
      </div>
      <div class="col-md-6 nopadding">
        <div class="split-content">
          <h1 class="wow fadeInUp">Designed for effective product landing page</h1>
     ...
     <div class="split-features2">
      ...
      <div class="col-md-6 nopadding">
        <div class="split-image"> <img class="img-responsive wow fadeIn" src="images/covid004.png" alt="Image" /> </div>
      </div>
    </div>

        <div class="split-features">
      <div class="col-md-6 nopadding">
        <div class="split-image"> <img class="img-responsive wow fadeIn" src="images/covid005.png" alt="Image" /> </div>
      </div>
      <div class="col-md-6 nopadding">
        <div class="split-content">
          <h1 class="wow fadeInUp">Designed for effective product landing page</h1>
      ...
      <div class="col-md-6 nopadding">
        <div class="split-image"> <img class="img-responsive wow fadeIn" src="images/covid006.png" alt="Image" /> </div>
      </div>
    </div>
