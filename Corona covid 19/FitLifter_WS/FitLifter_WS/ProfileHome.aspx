<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProfileHome.aspx.cs" Inherits="FitLifter_WS.ProfileHome" %>
...
<div class="wrapper">
  ...
  <div class="main app form" id="main"><!-- Main Section -->
    <div class="hero-section">
      <div class="container nopadding">
        <div id="ProfileImg" runat="server" class="col-md-5"> <img class="img-responsive wow fadeInUp" data-wow-delay="0.1s" src="images/app-signup.png" alt="App" /> </div>
        <div class="col-md-7">
  ...
  <%--  <div class="client-section" style="height:50px;">
   ...
   <%-- <div class="split-features">
    ...
    --%>
     ...
     <%--       <div class="split-features" onclick="onclick1('2')" style="cursor:pointer;">
      <div class="col-md-6 nopadding">
        <div class="split-image"> <img class="img-responsive wow fadeIn" src="images/app_image3.png" alt="Image" /> </div>
      </div>
      <div class="col-md-6 nopadding">
        <div class="split-content">
          <h1 class="wow fadeInUp">Designed for effective product landing page</h1>
   ...
   <%--  <div class="split-features2" onclick="onclick1('3')" style="cursor:pointer;">
      ...
      <div class="col-md-6 nopadding">
        <div class="split-image"> <img class="img-responsive wow fadeIn" src="images/app_image4.png" alt="Image" /> </div>
      </div>
    </div>--%>
