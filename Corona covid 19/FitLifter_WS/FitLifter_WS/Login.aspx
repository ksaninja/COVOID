<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="FitLifter_WS.Login" %>
...
<div class="wrapper">
 ...
 --%>          <p class="img-responsive wow fadeInUp" style="font-family:Calibri; margin-bottom:15px; margin-top:7vw; color:#aeaeae; font-size:17px;" >Please fill all information below.</p>
               ...
               <asp:TextBox ID="Password" class="img-responsive wow fadeInUp" onkeypress="return LoginTest(event)" onpaste="return false;" runat="server"  TextMode="Password"  placeholder="Password" style="width:100%; padding-left:5px; font-family:Calibri; margin-bottom:5px; padding-right:5px; height:40px; float:left;" ></asp:TextBox>
               ...
               <asp:button ID="btn1" class="img-responsive wow fadeInUp" Text="LOGIN" onclick="Login_Button_Clicked" OnClientClick="this.disabled = 'true'; this.value='Loging in please wait ...';" runat="server" BorderStyle="None" style="width:100%; color:white; font-family:Calibri; padding-left:5px;  background-color:#1eb858; margin-bottom:5px; padding-right:5px; height:40px; float:left;" UseSubmitBehavior="false" ></asp:button>
                ...
                <a href="ForgetPassword.aspx" class="img-responsive wow fadeInUp" style="font-family:Calibri; text-decoration:none; color:#1eb858; margin-bottom:15px; margin-top:7px; font-size:15px; float:right;" >Forget Password?</a>
