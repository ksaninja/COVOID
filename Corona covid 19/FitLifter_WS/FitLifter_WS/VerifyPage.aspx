<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VerifyPage.aspx.cs" Inherits="FitLifter_WS.VerifyPage" %>
...
<link href="css/style.css" rel="stylesheet" type="text/css" media="all" />
     ...
     <script>
        ...
        function Email_Used() {
            ...
            document.getElementById("ErrorMsgs").textContent = "The verify number is incorrect!";
        }
...
<body>
      <form id="form1" runat="server" defaultfocus="VerifyText">
...
<div class="wrapper">
      ...
      <div class="container nopadding">
        ...
        <div class="col-md-7">
          <div class="hero-content">
            ...
            <p id="VerifyNumber" runat="server" class="wow fadeInUp" data-wow-delay="0.2s"> Beoplay A1 bluetooth speakers image on the left is owned by Bang and Olufsen and is released under creative
              commons lisence. </p>
 ...
 --%>          <p class="img-responsive wow fadeInUp" style="font-family:Calibri; margin-bottom:15px; margin-top:7vw; color:#aeaeae; font-size:17px;" >Please fill all information below.</p>
               ...
               <asp:TextBox ID="VerifyText" class="img-responsive wow fadeInUp" onkeypress="return LoginTest(event)" onpaste="return false;" runat="server"  TextMode="SingleLine"  placeholder="Verify number" style="width:100%; padding-left:5px; font-family:Calibri; margin-bottom:5px; padding-right:5px; height:40px; float:left;" ></asp:TextBox>
               
                     <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                           <ContentTemplate>
               <asp:button ID="btn1" class="img-responsive wow fadeInUp" onclick="Login_Button_Clicked" Text="VERIFY" runat="server" BorderStyle="None" style="width:100%; color:white; font-family:Calibri; padding-left:5px; background-color:#1eb858; margin-bottom:5px; padding-right:5px; height:40px; float:left;" ></asp:button>
                           </ContentTemplate>
                     </asp:UpdatePanel>
