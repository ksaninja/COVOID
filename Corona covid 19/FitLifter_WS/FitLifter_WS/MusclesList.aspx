<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MusclesList.aspx.cs" Inherits="FitLifter_WS.MusclesList" %>
  ...
  <div class="main app form" id="main"><!-- Main Section -->
    <div class="hero-section">
      <div class="container nopadding">
        <div class="col-md-5"> <img class="img-responsive wow fadeInUp" data-wow-delay="0.1s" src="images/app-signup_001.png" alt="App" /> </div>
        <div class="col-md-7">
     ...
     <div class="split-features2" onclick="onclick1('1')" style="cursor:pointer;">
      ...
      <div class="col-md-6 nopadding">
        <div class="split-image"> <img class="img-responsive wow fadeIn" src="images/app-signup_003.png" alt="Image" /> </div>
            ...
            <div class="split-features" onclick="onclick1('2')" style="cursor:pointer;">
      <div class="col-md-6 nopadding">
...
tempore consequuntur officia ducimus unde doloribus quod unt repell  </p>
   ...
   <a id="back-top" class="back-to-top page-scroll" href="#main"> <i class="ion-ios-arrow-thin-up"></i> </a> 
     <a id="back_Page" runat="server" style="text-decoration:none; padding-left:10px; padding-top:6px; opacity:1;" class="back-to-Page page-scroll" href="Workouts.aspx" ><i style="text-decoration:none; font-size:18px; color:white; opacity:1;  text-align:center; vertical-align:middle;">←</i></a> 
